...
<head>
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="check_admin.jsp">
				 <div class="control-group normal_text"> <h3><img src="img/logo.png" alt="Logo" /></h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="text" placeholder="User ID" name="id" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
