...
<%@page import="certificate.student_pojo"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
 <jsp:useBean id="admin" class="certificate.student_pojo"></jsp:useBean>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"> <a href="student_report.jsp"><i class="icon icon-building"></i> <span>List Student</span></a> </li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <%
                   ArrayList<student_pojo> data=dao.FetchS();
                   
                   for(student_pojo obj:data)
                   {
                   %>
                 <tr>
                      <td><%=obj.getS_id()%></td>
