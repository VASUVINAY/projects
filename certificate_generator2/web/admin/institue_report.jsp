...
<%@page import="certificate.user_pojo"%>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <%
                   ArrayList<user_pojo> data=dao.FetchI();
                   
                   for(user_pojo obj:data)
                   {
                   %>
                 <tr>
                      <td><%=obj.getU_id()%></td>
                     <td><%=obj.getOwner_name()%></td>
                    
                          <td><%=obj.getOwner_id()%></td>
                            <td><%=obj.getCompany_id()%></td>
