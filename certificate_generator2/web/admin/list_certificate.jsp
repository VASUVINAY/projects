...
<%@page import="certificate.cerificate_issue_pojo"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
 <jsp:useBean id="admin" class="certificate.cerificate_issue_pojo"></jsp:useBean>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"> <a href="institue_report.jsp"><i class="icon-file"></i> <span>List Institute</span></a> </li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <%
                   ArrayList<cerificate_issue_pojo> data=dao.FetchCertificate();
                   
                   for(cerificate_issue_pojo obj:data)
                   {
                   %>
                 <tr>
                     <td><%=obj.getCertificate_no()%></td>
                      <td><%=obj.getU_id()%></td>
                      <td><%=obj.getS_id()%></td>
                      <td><%=obj.getIssue_date()%></td>
