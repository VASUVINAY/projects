...
String id=request.getParameter("id");
 ...
 ResultSet rs=stmt.executeQuery("select count(*) from user_info where u_id='"+id+"' and pass_word='"+pass+"' ");
 rs.next();
 int chk=rs.getInt(1);
// out.println("<h1>code  : "+code+"</h1>");
 if (chk>0) {
  //   session.setAttribute("code", code);
        out.println("<script>alert('Login Success'); window.location.href='user.jsp';</script>");
             }
 else
     {
