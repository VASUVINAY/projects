  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb span4"> <a href="user.jsp"> <i class="icon-dashboard"></i> My Dashboard </a> </li>
        <li class="bg_lg span4"> <a href="add_employee.jsp"> <i class="icon-building"></i>Add Employee</a> </li>
        <li class="bg_lg span4"> <a href="employee_report.jsp"> <i class="icon-building"></i>List Employee</a> </li>
        <li class="bg_lg span4"> <a href="add_student.jsp"> <i class="icon-building"></i>Add Student</a> </li>
        <li class="bg_lg span4"> <a href="student_report.jsp"> <i class="icon-building"></i>List Student</a> </li>
        <li class="bg_ls span4"> <a href="mark_attendence.jsp"> <i class="icon-file-alt"></i> Mark Attendence</a> </li>
        <li class="bg_ls span4"> <a href="certificate_issue.jsp"> <i class="icon-book"></i> Generate Certificate</a> </li>
