...
<%@page import="myarrange.employee_pojo"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
 <jsp:useBean id="admin" class="myarrange.employee_pojo"></jsp:useBean>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"> <a href="institue_report.jsp"><i class="icon-file"></i> <span>List Employee</span></a> </li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <%
                   ArrayList<employee_pojo> data=dao.FetchI();
                 ...
                 <tr>
                     ...
                     <td><%=obj.getE_name()%></td>
                          ...
                          <td><%=obj.getEmail()%></td>
                            <td><%=obj.getSex()%></td>
                            <td><%=obj.getDob()%></td>
                            <td><%=obj.getW_field()%></td>
                            <td><%=obj.getBranch()%></td>
                            <td><%=obj.getDesignation_name()%></td>
...
//                    alert(txt);
                    var url = "employeeDelete.jsp?id="+txt;
