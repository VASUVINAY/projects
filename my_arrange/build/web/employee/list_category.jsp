...
<%@page import="myarrange.category_pojo"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
 <jsp:useBean id="admin" class="myarrange.category_pojo"></jsp:useBean>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="list_category.jsp"><i class="icon icon-home"></i> <span>Category List</span></a> </li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <%
                   ArrayList<category_pojo> data=dao.FetchC();
