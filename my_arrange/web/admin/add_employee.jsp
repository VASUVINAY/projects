...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"> <a href="add_employee.jsp"><i class="icon icon-building"></i> <span>Add Employee</span></a> </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
        <a href="#" class="current">Add Employee</a> </div>
    <h1>ADD Employee</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="get_employee.jsp" name="basic_validate" id="basic_validate" novalidate="novalidate">
              ...
              <div class="control-group">
                <label class="control-label">Sex(M/F)</label>
                <div class="controls">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                 ...
                 <div class="control-group">
                <label class="control-label">Previous Working(TECHNICAL/NON-TECHNICAL)</label>
                <div class="controls">
                  <input type="text" name="prework" id="prework">
                </div>
              </div>
                 <div class="control-group">
