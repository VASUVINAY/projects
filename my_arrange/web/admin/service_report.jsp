...
<%@page import="myarrange.service_provider_pojo"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
 <jsp:useBean id="admin" class="myarrange.service_provider_pojo"></jsp:useBean>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"> <a href="service_report.jsp"><i class="icon-file"></i> <span>List Service provider</span></a> </li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <%
                   ArrayList<service_provider_pojo> data=dao.FetchE();
                   
                   for(service_provider_pojo obj:data)
                   {
                   %>
                 <tr>
                      <td><%=obj.getS_id()%></td>
                     <td><%=obj.getS_name()%></td>
                          ...
                          <td><%=obj.getC_id()%></td>
                            <td><%=obj.getContact1()%></td>
                            <td><%=obj.getContact2()%></td>
                            <td><%=obj.getEmail()%></td>
                            <td><%=obj.getVideo_link()%></td>
                            <td><%=obj.getBanner_id()%></td>
                            <td><%=obj.getL_id()%></td>
                            <td><%=obj.getAbout()%></td>
                            <td><%=obj.getWebsite()%></td>
                            <td><%=obj.getHome_delivery()%></td>
                            <td><%=obj.getSubscription()%></td>
                            <td><%=obj.getE_id()%></td>
