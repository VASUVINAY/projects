...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="location.jsp"><i class="icon icon-signal"></i> <span>Add Location</span></a> </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
        <a href="#" class="current">Add Location</a> </div>
    <h1>ADD Location</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="get_employee.jsp" name="basic_validate" id="basic_validate" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="number" name="shop_number" id="shop_number">
                </div>
              </div>
              <div class="control-group">
